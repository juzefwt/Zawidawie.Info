...
use Herzult\Bundle\ForumBundle\Controller\ForumController as BaseController;
...
class ForumController extends BaseController
{
    ...
    {
        return $this->get('templating')->renderResponse('ZawidawieInfoForumBundle:Forum:index.html.'.$this->getRenderer(), array(
    ...
    public function searchAction()
    {
        ...
        return $this->get('templating')->renderResponse('ZawidawieInfoForumBundle:Forum:search.html.'.$this->getRenderer(), array(
